...
if html_start != -1 and html_end != -1:
    new_html = """{/* Canvas / Image Display Area */}
                      ...
                      >
                        <div className="relative max-w-full max-h-full flex-1 h-full flex items-center justify-center">
                            <div className="relative w-full h-full" style={{ aspectRatio: rasterImage ? `${rasterImage.width} / ${rasterImage.height}` : '1' }}>
