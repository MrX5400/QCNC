...
adjustments = """          <div className="space-y-4">
            <h4 className="font-bold text-slate-100 border-b border-slate-700/50 pb-1.5 flex items-center gap-2">
...
# Insert right after the Bild-Transformation section
target = '          {/* 3. Erweiterte Filter / Experten-Einstellungen */}'
text = text.replace(target, adjustments + '\n' + target)

# Add Sun icon to lucide-react imports if missing
if 'Sun' not in text:
    text = text.replace('FlipVertical,', 'FlipVertical,\n  Sun,')
