          ...
          <div className="flex-1 bg-slate-950/80 relative flex flex-col min-h-0">
            ...
            >
              <div className="relative inline-block max-w-full max-h-full">
                {/* Invisible image to strictly dictate dimensions and aspect ratio */}
                {image && (
                   <img 
                     src={image.src} 
                     alt="" 
                     className="invisible max-w-full max-h-full object-contain pointer-events-none"
                   />
                )}
                
                {/* Overlay Container perfectly hugging the image */}
